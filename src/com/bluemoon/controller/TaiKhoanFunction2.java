...
public class TaiKhoanFunction2 {
    ...
    public TaiKhoanFunction2(JButton btnSubmit, JTextField jtfMaTaiKhoan, JTextField jtfHoTen, JTextField jtfTenTaiKhoan, JTextField jtfMatKhau,
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    if (!checkNotNull()) {
                        ...
                        taiKhoan.setMat_khau(jtfMatKhau.getText());
                        ...
                        if (showDialog()) {
                            ...
                            if (lastId == 0) {
                                ...
                                jtfMaTaiKhoan.setText(String.valueOf(taiKhoan.getMa_tai_khoan()));
                                jlbMsg.setText("Xử lí thông tin thành công!");
