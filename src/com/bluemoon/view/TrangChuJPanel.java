...
public class TrangChuJPanel extends javax.swing.JPanel {
    public TrangChuJPanel() {
        ...
        NhanKhauServiceImpl nhanKhau = new NhanKhauServiceImpl();
        jLabel5.setText(String.valueOf(nhanKhau.getCount()));
        HoGiaDinhServiceImpl hoGiaDinh = new HoGiaDinhServiceImpl();
        jLabel2.setText(String.valueOf(hoGiaDinh.getCount()));
        LoaiPhiServiceImpl loaiPhi = new LoaiPhiServiceImpl();
        jLabel8.setText(String.valueOf(loaiPhi.getCount()));
