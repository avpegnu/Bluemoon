...
public class ThongKePhiTienIchJPanel extends javax.swing.JPanel {
    public ThongKePhiTienIchJPanel() {
        initComponents();
        
        ThongKeController controller = new ThongKeController();
        controller.setDataToChart3(jpnChart);
        
        ThuPhiController controller1 = new ThuPhiController(jpnView, btnAdd, jtfSearch);
        controller1.setDataToTable3();
